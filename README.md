The purpose of this collection of R scripts is to act as a template for others who want to make similar graphs and want to save time by using a template.
